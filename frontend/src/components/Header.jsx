  ...
  return (
    <>
      ...
      <header
        // style={{
        //   background:
        //     "linear-gradient(135deg, #1a0a00 0%, #2d1200 40%, #3d1a00 70%, #1a0a00 100%)",
        // }}.
        // style={{
        //   background:
        //     "linear-gradient(135deg, #fff7ed 0%, #ffffff 50%, #fff7ed 100%)",
        // }}
        className="sticky font-poppins  top-0  w-full bg-white/95 backdrop-blur-md z-50  border-b border-orange-100"
      >

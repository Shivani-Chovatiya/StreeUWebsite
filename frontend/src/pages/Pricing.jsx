    ...
    <div className="font-poppins">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
        ...
        <div className="p-3 md:p-6">
          <h1 className="text-xl md:text-3xl  font-bold text-black  animate-slide-up">
            Future Prediction Package
          </h1>
        </div>
        {/* Package Cards */}
        ...
        <div className="p-3 md:p-6 mt-5">
          <h1 className="text-xl md:text-3xl  font-bold text-black  animate-slide-up">
            Psychological Counselling Package
          </h1>
        </div>
        {/* Package Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {psychologicalPackages.map((item, i) => (
            <div
              key={i}
              // className="bg-gradient-to-b from-[#8B1E00] to-[#FF6A2B] text-white rounded-3xl p-8 shadow-xl"
              className="group relative bg-gradient-to-br from-white to-orange-50 border-2 border-primary/30 rounded-3xl p-6 md:p-8 shadow-lg hover:shadow-2xl hover:border-primary transition-all duration-300 hover:scale-105 animate-scale-in"
              style={{ animationDelay: `${i * 0.1}s` }}
            >
              {/* Title */}
              ...
              {/* Discount */}
              <p className="text-primary text-center font-semibold mt-1">
                {item.discount}
              </p>

              {/* Description */}
              <p className="text-center text-sm mt-2 mb-6 opacity-90">
                {item.description}
              </p>
              ...
              {/* Button */}
              {/* <button className="w-full bg-white text-black font-semibold py-3 rounded-xl hover:bg-gray-100 transition">
                  Select Package
                </button> */}
            </div>
          ))}

...
import aboutus from "../assets/Aboutusimg/AboutUsPage.png";
...
const AboutUs = () => {
  ...
  return (
    ...
    <div className="font-poppins">
      ...
      <div
        ref={aboutRef}
        className="grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-8 lg:px-16 py-12 "
      >
        <div
      ...
      {/* <div
        ref={descRef}
        className={`flex flex-col justify-center items-center px-4 md:px-8 py-8 transition-all duration-1000 ${
          descVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
        <p className="text-black font-semibold text-sm md:text-base text-center leading-relaxed">
          {t("aboutus.description")}
        </p>
        <br></br>
        <p className="text-black font-semibold text-sm md:text-base text-center leading-relaxed">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-8 lg:px-16 ">
          <div
      ...
      <div
        ref={statsRef}
        className="justify-center items-center flex bg-gradient-to-br from-white via-orange-50 to-white py-16 px-4 md:px-8"
      >
        <div className="  grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-8 justify-items-center">
          {data.map((item, index) => (
            <div
              key={String(index + 1)}
              className={`group flex flex-col gap-4 items-center p-6 md:px-16 bg-white rounded-2xl shadow-md hover:shadow-xl border-2 border-orange-100 hover:border-primary transition-all duration-700 hover:scale-105 ${
                statsVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-10"
              }`}
